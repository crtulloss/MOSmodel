...
% to change body bias through VSB
% need to change code so VSB can always be a vector
...
% plot gm/ID vs logID for several VSB, finely spaced VGS
...
% output conductance
% plot go = dID/dVDS vs VDS (fine spacing), esp around sat transition
% for one or more VGS in strong inversion
